...
extends Button {
    ...
    public void drawScreen(class_332 context, int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawString(this.setting.getName() + " " + String.valueOf(class_124.field_1080) + (this.setting.currentEnumName().equalsIgnoreCase("ABC") ? "ABC" : this.setting.currentEnumName()), (double)(this.x + 2.3f), (double)(this.y - 1.7f - (float)DuckFlowGUI.getClickGui().getTextOffset()), this.getState() ? -1 : -5592406);
    }
